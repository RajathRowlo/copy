...
userApiObj.post("/login", errorHandler(async (req, res) => {
    ...
    //if user is existed compare password
        ...
        //if password is match
            ...
            let signedToken = await jwt.sign({ username: userFromDb.username }, "secret", { expiresIn: 100 })
...
userApiObj.post("/addtocart", errorHandler(async (req, res) => {
...
userApiObj.post("/getcart", errorHandler(async (req, res) => {
